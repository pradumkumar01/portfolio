...
company : 'Company Name'
  ...
  return (
    <div className="mt-5">
      <div className="bg-white h-56 p-4 rounded-md shadow-lg">
        <div className="ml-1">
        <div>
          <h1 className="text-xl ml-2 font-semibold text-zinc-500">Experience</h1>
        </div>
        <div className="mt-2">
        {exp.map((item,index)=>{
          return (
<div key={index} className="border-l ml-4 relative">
            ...
            <p className="ml-2 text-zinc-700">Position</p>
